...
public class Feature implements Util
{
    ...
    public Feature() {
        ...
        this.renderer = Storm.textManager;
    }
    ...
    public Setting register(final Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof StormGui) {
            StormGui.getInstance().updateModule((Module)this);
        }
        return setting;
    }
