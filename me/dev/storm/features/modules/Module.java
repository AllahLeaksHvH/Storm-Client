...
package me.dev.storm.features.modules;
...
public class Module extends Feature
{
    ...
    public void enable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue()) {
            final TextComponentString text = new TextComponentString(Storm.commandManager.getClientMessage() + ChatFormatting.WHITE + " " + this.getDisplayName() + ChatFormatting.GREEN + ChatFormatting.BOLD + " enabled.");
    ...
    public void disable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue()) {
            final TextComponentString text = new TextComponentString(Storm.commandManager.getClientMessage() + ChatFormatting.WHITE + " " + this.getDisplayName() + ChatFormatting.RED + ChatFormatting.BOLD + " disabled.");
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion((ITextComponent)text, 1);
        }
        this.onToggle();
        this.onDisable();
    ...
    public void setDisplayName(final String name) {
        final Module module = Storm.moduleManager.getModuleByDisplayName(name);
        final Module originalModule = Storm.moduleManager.getModuleByName(name);
