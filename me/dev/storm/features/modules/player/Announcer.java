...
public class Announcer extends Module
{
    ...
    static {
        ...
        Announcer.eattingDelay = 0;
        Announcer.walkMessage = "I just moved {blocks} blocks thanks to storm";
        Announcer.breakMessage = "I just broke {amount} {name} thanks to storm";
        Announcer.eatMessage = "I just ate {amount} {name} thanks to storm";
    }
}
