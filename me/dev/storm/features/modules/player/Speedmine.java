...
public class Speedmine extends Module
{
    ...
    public void onTick() {
        ...
        if (this.currentPos != null && Util.mc.player != null && Util.mc.player.getDistanceSq(this.currentPos) > MathUtil.square(this.range.getValue())) {
    ...
    public void onRender3D(final Render3DEvent event) {
        if (this.render.getValue() && this.currentPos != null) {
            ...
            RenderUtill.gradientBox(this.currentPos, color, this.lineWidth.getValue(), this.outline.getValue(), this.box.getValue(), this.boxAlpha.getValue(), true);
        }
    }
