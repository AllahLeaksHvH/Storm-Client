...
public class MovementUtil
{
    ...
    public static double[] futureCalc1(final double d) {
        ...
        if (d2 == 0.0 && d3 == 0.0) {
            ...
            d5 = d2 * d * Math.cos(Math.toRadians(f + 90.0f)) + d3 * d * Math.sin(Math.toRadians(f + 90.0f));
            d4 = d2 * d * Math.sin(Math.toRadians(f + 90.0f)) - d3 * d * Math.cos(Math.toRadians(f + 90.0f));
        }
