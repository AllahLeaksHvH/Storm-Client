...
public class RenderUtil implements Util
{
    ...
    public static void drawModalRect(final int x, final int y, final float u, final float v, final int uWidth, final int vHeight, final int width, final int height, final float tileWidth, final float tileHeight) {
    ...
    public static void drawEntityBoxESP(final Entity target, final Color current, final boolean b, final Color color, final float v, final boolean b1, final boolean b2, final int i) {
    }
    
    public void drawText(final BlockPos blockPos, final String s, final Color color) {
    }
