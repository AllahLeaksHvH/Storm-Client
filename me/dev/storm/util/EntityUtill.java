...
public class EntityUtill implements Util
{
    ...
    public static double getBaseMoveSpeed() {
        ...
        if (EntityUtill.mc.player != null && EntityUtill.mc.player.isPotionActive((Potion)Objects.requireNonNull(Potion.getPotionById(1)))) {
            final int amplifier = Objects.requireNonNull(EntityUtill.mc.player.getActivePotionEffect((Potion)Objects.requireNonNull(Potion.getPotionById(1)))).getAmplifier();
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtill.mc.player) || (entity instanceof EntityPlayer && Storm.friendManager.isFriend(entity.getName())) || EntityUtill.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
