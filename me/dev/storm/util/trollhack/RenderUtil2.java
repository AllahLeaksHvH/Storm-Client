...
import java.awt.*;
import me.dev.storm.util.render.*;
...
public class RenderUtil2 implements Util
{
    ...
    public static void updateModelViewProjectionMatrix() {
        ...
        GLUProjection.getInstance().updateMatrices(RenderUtil2.viewport, RenderUtil2.modelView, RenderUtil2.projection, (double)(res.getScaledWidth() / (float)Minecraft.getMinecraft().displayWidth), (double)(res.getScaledHeight() / (float)Minecraft.getMinecraft().displayHeight));
    }
    ...
    public static void drawBBFill(final AxisAlignedBB axisAlignedBB, final Color color, final int n) {
        ...
        if (RenderUtil2.camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB2.minX + RenderUtil.mc.getRenderManager().viewerPosX, axisAlignedBB2.minY + RenderUtil.mc.getRenderManager().viewerPosY, axisAlignedBB2.minZ + RenderUtil.mc.getRenderManager().viewerPosZ, axisAlignedBB2.maxX + RenderUtil.mc.getRenderManager().viewerPosX, axisAlignedBB2.maxY + RenderUtil.mc.getRenderManager().viewerPosY, axisAlignedBB2.maxZ + RenderUtil.mc.getRenderManager().viewerPosZ))) {
    ...
    public static void drawGradientRectTwo(final float left, final float top, final float right, final float bottom, final int coltl, final int coltr, final int colbl, final int colbr) {
        GlStateManager.disableTexture2D();
        GlStateManager.enableBlend();
        GlStateManager.disableAlpha();
    ...
    public static void drawColorShader(final int x1, final int y1, final int x2, final int y2, final int color, final int radius) {
        final int a = 50;
        final float f = (color >> 16 & 0xFF) / 255.0f;
        final float f2 = (color >> 8 & 0xFF) / 255.0f;
        final float f3 = (color >> 0 & 0xFF) / 255.0f;
        drawGradientRectTwo((float)(x1 - radius), (float)y1, (float)x1, (float)y2, ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, (float)a));
        drawGradientRectTwo((float)x2, (float)y1, (float)(x2 + radius), (float)y2, ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, 0.0f));
        drawGradientRectTwo((float)x1, (float)(y1 - radius), (float)x2, (float)y1, ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, (float)a));
        drawGradientRectTwo((float)x1, (float)y2, (float)x2, (float)(y2 + radius), ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, 0.0f));
        drawGradientRectTwo((float)(x1 - radius), (float)(y1 - radius), (float)x1, (float)y1, ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, (float)a));
        drawGradientRectTwo((float)x2, (float)(y1 - radius), (float)(x2 + radius), (float)y1, ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, 0.0f));
        drawGradientRectTwo((float)(x1 - radius), (float)y2, (float)x1, (float)(y2 + radius), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, 0.0f));
        drawGradientRectTwo((float)x2, (float)y2, (float)(x2 + radius), (float)(y2 + radius), ColorUtil.toRGBA(f, f2, f3, (float)a), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, 0.0f), ColorUtil.toRGBA(f, f2, f3, 0.0f));
    }
    ...
    public static void drawSexyBox(final AxisAlignedBB a, final Color boxColor, final Color outlineColor, final float lineWidth, final boolean outline, final boolean box, final boolean colorSync, float alpha, final float scale, final float slab) {
    ...
    public static void drawGradientPlaneBB(final AxisAlignedBB axisAlignedBB, final EnumFacing enumFacing, final Color color, final Color color2, final double d) {
        final Tessellator tessellator = Tessellator.getInstance();
        final BufferBuilder bufferBuilder = tessellator.getBuffer();
        final float f = color.getRed() / 255.0f;
        final float f2 = color.getGreen() / 255.0f;
        final float f3 = color.getBlue() / 255.0f;
        final float f4 = color.getAlpha() / 255.0f;
        final float f5 = color2.getRed() / 255.0f;
        final float f6 = color2.getGreen() / 255.0f;
        final float f7 = color2.getBlue() / 255.0f;
        final float f8 = color2.getAlpha() / 255.0f;
        double d2 = 0.0;
        double d3 = 0.0;
        double d4 = 0.0;
        double d5 = 0.0;
    ...
    public static void drawText(final AxisAlignedBB pos, final String text) {
        ...
        Storm.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.popMatrix();
    }
    ...
    public static void drawProjectedText(final GLUProjection.Projection projection, final float addX, final float addY, final String text, final Color color, final boolean shadow) {
        if (projection.getType() == GLUProjection.Projection.Type.INSIDE) {
            GlStateManager.pushMatrix();
            GlStateManager.translate(projection.getX(), projection.getY(), 0.0);
            Storm.textManager.drawString(text, -(Storm.textManager.getStringWidth(text) / 2.0f) + addX, addY, color.getRGB(), shadow);
            GlStateManager.translate(-projection.getX(), -projection.getY(), 0.0);
            GlStateManager.popMatrix();
        }
    }
